...
const carouselInner = carousel.querySelector('.product-slider__images');
const prevButton = carousel.querySelector('.navigation-button__previous');
const nextButton = carousel.querySelector('.navigation-button__next');
